...
struct NodoArbolBinario * encontrarUltimoNodoDerecha(struct ArbolBinario &arbol);
void transaccionFinal(struct NodoArbolBinario* nodo);
void reemplazarRaiz(struct NodoArbolBinario* ultimoNodo,struct ArbolBinario &arbol);
